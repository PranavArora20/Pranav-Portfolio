...
const Navbar = () => {
  ...
  const handleMenuItemClick = (sectionId) => {
    ...
    if (sectionId === "home") {
      ...
      // Scroll to specific section with offset for fixed navbar
  ...
  return (
    ...
    >
      <div className="text-white py-5 flex justify-between items-center">
        {/* Logo */}
        <div 
          className="text-lg font-semibold cursor-pointer hover:scale-105 transition-transform duration-300"
